...
ret1 = convmod0_conv1_act.data.cpu().numpy()[0,0,...]
...
ret2 = convmod0_conv2_act.data.cpu().numpy()[0,0,...] 
write_h5(ret2,"ret2.h5") 

convmod0_conv3 = net.module.convmod0.conv3(convmod0_conv2_act)   
ret2_5 = convmod0_conv3.data.cpu().numpy()[0,0,...] 
write_h5(ret2_5,"ret_conv2_d0.h5") 

convmod0_conv3_sum = convmod0_conv3+convmod0_conv1_act
convmod0_conv3_bn = net.module.convmod0.bn3(convmod0_conv3_sum) 
convmod0_conv3_act = net.module.convmod0.activation(convmod0_conv3_bn)
ret3 = convmod0_conv3_act.data.cpu().numpy()[0,0,...] 
write_h5(ret3,"ret_sum0_d0.h5") 
