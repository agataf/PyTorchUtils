...
def fill_params(expt_name, chkpt_num, batch_sz, lr, gpus,
    ...
    params["train_sets"]   = ["vol19-34_train", "vol401_train", "vol501_train", "vol502_train", "vol503_train", "vol104_train", "vol102_train", "vol103_train", "vol101_train"]
    params["val_sets"]     = ["vol19-34_val", "vol401_val", "vol501_val", "vol502_val", "vol503_val", "vol104_val", "vol102_val", "vol103_val", "vol101_val"]
