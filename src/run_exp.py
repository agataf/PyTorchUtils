...
def fill_params(expt_name, chkpt_num, batch_sz, lr, gpus,
    ...
    train_vol_list = ["stitched_vol19-vol34_train", "vol101_train", "vol102_train", "vol103_train", "vol104_train", "vol401_train", "vol501_train", "vol502_train", "vol503_train"] #"stitched_vol40-vol41_train"
    val_vol_list = ["stitched_vol19-vol34_val", "vol401_train", "vol501_val", "vol502_val", "vol503_val"] # "stitched_vol40-vol41_val",
    params["erode"] = erode
#     if erode:
...
def start_training(model_class, model_args, model_kwargs, chkpt_num,
    ...
    train_sampler = utils.AsyncSampler(Sampler(data_dir, dsets=train_sets,
                                               mode="train", erode=erode, patchsz=(16,160,160)))

    val_sampler   = utils.AsyncSampler(Sampler(data_dir, dsets=val_sets,
                                               mode="val", erode=erode, patchsz=(16,160,160)))
