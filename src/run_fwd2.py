...
def fill_params(expt_name, chkpt_num, gpus,
    ...
    #Model params
    params["in_dim"]      = 1
    params["output_spec"]  = collections.OrderedDict(mit0_label=1,mit1_label=1, mit2_label=1, mit3_label=1)
    params["depth"]       = 4
    ...
    params["scan_spec"]   = collections.OrderedDict(img0=(1,16,320,320), img1=(1,16,320,320), img2=(1,16,320,320), img3=(1,16,320,320))
